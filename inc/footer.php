		...
		<div class="container">
			<div class="row">
				<div class="col-md-5">
					<div class="row">
						<div class="col-md-12">
							<a href="index.php"><img src="img/logo-menu.png" class="img-responsive logo-rodape"><br></a>
							<div class="texto-header">
								<span><i class="fas fa-clock"></i>&nbsp;Segunda a Sexta das 8:00 às 18:00<br />&emsp;Sábado das 8:00 às 12:00</span>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					...
					Copyright © 2018 Instituto Veiga - Todos os direitos reservados.<br>
